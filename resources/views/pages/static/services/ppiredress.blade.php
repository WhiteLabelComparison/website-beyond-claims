...
@section('title', 'Payment Protection Insurance Redress')
...
@section('content')
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="welcome">
                    <div class="page-name pull-left"><h3>Payment Protection Insurance Redress</h3></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container marg50">
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="name_serv">What is Payment Protection Insurance Redress?</div>
                <p class="about_text">
