...
<div class="container marg50">
    <div class="row">
        <div class="col-lg-8 col-md-8">
            ...
            <p class="about_text">Beyond Comparison Claims can assess your claim and advise if we believe you have been miss-sold a package bank account. Our team knows where the banks have cut corners or not advised you as they should have. Get in touch for us to start your claim. You may have been miss-sold for one or more of the following reasons.</p>
            ...
            <div class="col-lg-6 marg25">
                <div class="iconbox"><i class="fa fa-gbp size_35"></i><br>
                    ...
                    <p class="text_serv">Was the extra cost that you paid on a monthly basis made clear to you and was it affordable for you? If not then it's possible that you were miss-sold.</p>
                </div>
            </div>
            <div class="col-lg-6 marg25">
        ...
        <div class="col-lg-4 col-md-4">
            ...
            <div class="col-lg-12 marg25">
                <div class="iconbox"><i class="fa fa-phone-square size_35"></i><br>
                    ...
                    <p class="text_serv">We will discuss your circumstances and establish if you have a valid claim. According to the regulators, around 1 in 5 people have a valid claim for their miss-sold account.</p>
                </div>
            </div>
